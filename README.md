...
## 概要
本プロジェクトは、金融機関向けのバックオフィス業務（HR・給与計算ドメイン）を想定した従業員情報の管理アプリケーションです。
...
## 開発の目的
現職（自治体系の業務SE）の税務・基幹システム保守運用で培った「課税ドメイン知識」と「システム保守の視点」を、モダンなWeb開発技術（PHP/Docker）と融合させ、金融機関向けシステム開発を担うエンジニアとして即戦力に近い形で貢献できる基盤を作ることを目標としています。
